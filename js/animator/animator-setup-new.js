...
var drawings = require('../js/animator/drawings-new.js')(window.Path2D);
var Canvas = require('../js/animator/canvas-new.js');
var Assets = require('../js/animator/assets-new.js');
